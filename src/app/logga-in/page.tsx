              ...
              <section className="bg-card p-6 rounded-xl shadow border border-border">
                ...
                {message && (
                  <p className="text-sm text-destructive mb-4">
                    Du måste <a href="/registrera" className="underline text-primary">registrera dig</a> och logga in för att komma åt kassan.
                  </p>
                )}
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <Button type="button" variant="outline" onClick={() => router.push('/')} disabled={isSubmitting}>Avbryt</Button>
