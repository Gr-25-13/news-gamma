        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-md font-semibold bg-secondary text-secondary-foreground px-8 py-3 shadow-sm"
              >
                Sök
              </button>
            </form>
                  ...
                  >
                    ...
                    >
                      ...
                      {s.thunderProbability > 0 && (
                        <div
                          className={`${getThunderRiskLevel(s.thunderProbability).bgClass} p-2 rounded-md flex justify-between items-center`}
                        ...
                        >
                          ...
                          <span
                            className={`${getThunderRiskLevel(s.thunderProbability).textClass} font-semibold`}
                          >
